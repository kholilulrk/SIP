                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <x-jet-input id="name" class="form-control" type="text" name="name" placeholder="Name"
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <x-jet-input id="email" class="form-control" placeholder="Email" type="email" name="email"
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <x-jet-input id="password_confirmation" class="form-control" placeholder="Konfirmasi Password" type="password"
